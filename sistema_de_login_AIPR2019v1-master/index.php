    ...
    <main class="container mt-4">
     <!-- Conteúdo Principal --> 
        ...
        <form action="#" class="p-2" id="frmCadastro">
            ...
            <div class="form-group">
                <input type="text" name="nomeUsuario" id="nomeUsuario" class="form-control" placeholder="Nomde de Usuário" required>
            </div>
            ...
            <div class="form-group">
                <input type="password" name="senhaConfirma" id="senhaConfirma" class="form-control" placeholder="Confirmar a sua senha"  required>
            </div>

            <div class="form-group">
                <div class="custom-control custom-checkbox">
                    <input type="checkbox" name="concordar" id="concordar" class="custom-control-input">
                    <label for="concordar" class="custom-control-label"> Eu concordo com os <a href="#"> termos e condições.</a>
                </div>
            </div>
            ...
            <div class="form-group">
                <p class="text-center"> Já cadastrado ? <a href="#" id="btnJaCadastrado"> Entrar aqui.</a>
                </p>
            </div>
